...
class App:
    def __init__(self, root):
        ...
        root.resizable(0,  0)
        root.title("Raushan®")
        root.configure(background="#5accae")
        root.configure(highlightbackground="#5accae")
        root.configure(highlightcolor="blue")
        self.dir = StringVar()
        ...
        self.title.configure(activeforeground="#030645")
        self.title.configure(background="#5accae")
        self.title.configure(disabledforeground="#a3a3a3")
        self.title.configure(font="-family {Arial Rounded MT Bold} -size 10")
        self.title.configure(foreground="#030645")
        self.title.configure(highlightbackground="#5accae")
        self.title.configure(highlightcolor="blue")
        ...
        self.TNotebook1.tab(0, text="Converter", compound="left", underline="-1"
                ,)
        self.TNotebook1_t1.configure(background="#5accae")
        self.TNotebook1_t1.configure(highlightbackground="#5accae")
        self.TNotebook1_t1.configure(highlightcolor="blue")
        self.TNotebook1_t2 = tk.Frame(self.TNotebook1)
        self.TNotebook1.add(self.TNotebook1_t2, padding=3)
        self.TNotebook1.tab(1, text="Help",compound="left",underline="-1",)
        self.TNotebook1_t2.configure(background="#5accae")
        self.TNotebook1_t2.configure(highlightbackground="#5accae")
        self.TNotebook1_t2.configure(highlightcolor="blue")
        self.TNotebook1_t3 = tk.Frame(self.TNotebook1)
        self.TNotebook1.add(self.TNotebook1_t3, padding=3)
        self.TNotebook1.tab(2, text="About",compound="none",underline="-1",)
        self.TNotebook1_t3.configure(background="#5accae")
        self.TNotebook1_t3.configure(highlightbackground="#5accae")
        self.TNotebook1_t3.configure(highlightcolor="blue")

        self.Label2 = tk.Label(self.TNotebook1_t1)
        self.Label2.place(relx=0.242, rely=0.066, height=33, width=327)
        self.Label2.configure(activebackground="#f9f9f9")
        self.Label2.configure(activeforeground="blue")
        self.Label2.configure(background="#5accae")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(font="-family {Arial Rounded MT Bold} -size 9")
        self.Label2.configure(foreground="#030645")
        self.Label2.configure(highlightbackground="#5accae")
        self.Label2.configure(highlightcolor="blue")
        ...
        self.start_btn.configure(activeforeground="#030645")
        self.start_btn.configure(background="#5accae")
        self.start_btn.configure(disabledforeground="#a3a3a3")
        self.start_btn.configure(font="-family {Arial Rounded MT Bold} -size 9")
        self.start_btn.configure(foreground="#030645")
        self.start_btn.configure(highlightbackground="#5accae")
        self.start_btn.configure(highlightcolor="blue")
        ...
        self.output_msg.place(relx=0.160, rely=0.593, relheight=0.345
                , relwidth=0.697)
        self.output_msg.configure(background="#5accae")
        self.output_msg.configure(font="-family {Arial} -size 9")
        self.output_msg.configure(foreground="#030645")
        self.output_msg.configure(highlightbackground="#5accae")
        self.output_msg.configure(highlightcolor="blue")
        ...
        self.Entry1.configure(foreground="#030645")
        self.Entry1.configure(insertbackground="blue")
        ...
        self.help_text.configure(foreground="blue")
        self.help_text.configure(highlightbackground="#5accae")
        self.help_text.configure(highlightcolor="blue")
        self.help_text.configure(insertbackground="blue")
        ...
        self.about_text.configure(activeforeground="blue")
        self.about_text.configure(background="#5accae")
        self.about_text.configure(disabledforeground="#a3a3a3")
        self.about_text.configure(font="-family {Arial} -size 9")
        self.about_text.configure(foreground="#030645")
        self.about_text.configure(highlightbackground="#5accae")
        self.about_text.configure(highlightcolor="blue")
        ...
        self.linkedin_btn.configure(activeforeground="#030645")
        self.linkedin_btn.configure(background="#5accae")
        ...
        self.linkedin_btn.configure(foreground="#030645")
        self.linkedin_btn.configure(highlightbackground="#5accae")
        self.linkedin_btn.configure(highlightcolor="blue")
        ...
        self.github_btn.configure(activeforeground="#030645")
        self.github_btn.configure(background="#5accae")
        self.github_btn.configure(disabledforeground="#a3a3a3")
        self.github_btn.configure(font="-family {Arial Rounded MT Bold} -size 9")
        self.github_btn.configure(foreground="#030645")
        self.github_btn.configure(highlightbackground="#5accae")
        self.github_btn.configure(highlightcolor="blue")
        ...
        self.website_btn.configure(activeforeground="#030645")
        self.website_btn.configure(background="#5accae")
        self.website_btn.configure(disabledforeground="#a3a3a3")
        self.website_btn.configure(font="-family {Arial Rounded MT Bold} -size 9")
        self.website_btn.configure(foreground="#030645")
        self.website_btn.configure(highlightbackground="#5accae")
        self.website_btn.configure(highlightcolor="blue")
